 ...
 * @author chave
 */
public class pnlAvisos extends javax.swing.JPanel {

    ServiciosUsuario servicio;
    List<Mensaje> listaAviso ;
    public pnlAvisos() throws ClassNotFoundException, SQLException {
        initComponents();       
...
/**
    ...
    private void txtBuscarsolicitudKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarsolicitudKeyReleased
        try {
            ...
            Logger.getLogger(pnlAvisos.class.getName())
